...
export const recentNotificationState: NotificationState = {
	notifiedTasks: {
		'notified:inline:due/today.md:2026-06-11:due01:2026-06-11':
			FIXTURE_NOW_MS,
		'notified:frontmatter:due/today-note.md:2026-06-11:2026-06-11':
			FIXTURE_NOW_MS,
	},
	notifiedAtTimeInstances: {},
...
export function notificationStateWithTask(
	taskId: string,
	dateStr: string,
): NotificationState {
	return {
